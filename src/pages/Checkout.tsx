            ...
            <div className="rounded-lg border bg-card p-6 shadow-card">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="phone" type="tel" placeholder="+234 XXX XXX XXXX" value={form.phone} onChange={(e) => update("phone", e.target.value)} required />
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg border bg-card p-6 shadow-card">
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="address" placeholder="123 Main Street" value={form.address} onChange={(e) => update("address", e.target.value)} required />
                </div>
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="city">City</Label>
                    <Input id="city" placeholder="Kaduna" value={form.city} onChange={(e) => update("city", e.target.value)} required />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="state">State</Label>
                    <Input id="state" placeholder="Kaduna State" value={form.state} onChange={(e) => update("state", e.target.value)} required />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-lg border bg-card p-6 shadow-card">
              ...
              <div className="grid gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="cardName" placeholder="JOHN DOE" value={form.cardName} onChange={(e) => update("cardName", e.target.value.toUpperCase())} required />
                </div>
                <div className="space-y-2">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-lg border bg-card p-6 shadow-card sticky top-24">
              ...
              <Button
                ...
                size="lg"
                disabled={processing}
                className="w-full mt-6 gradient-accent text-accent-foreground font-semibold shadow-accent border-0 hover:opacity-90"
              >
                {processing ? "Processing Payment..." : `Pay ${formatNaira(total)}`}
              </Button>
              {subtotal > 500000 && (
                <p className="text-xs text-center text-muted-foreground mt-2">🎉 Free delivery on orders above ₦500,000</p>
              )}
            </div>
          </div>
        </div>
